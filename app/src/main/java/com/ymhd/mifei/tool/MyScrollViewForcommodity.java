...
public class MyScrollViewForcommodity extends ScrollView {
	public MyScrollViewForcommodity(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	private static final String TAG = "MyScrollViewForcommodity ";
	...
	public MyScrollViewForcommodity(Context context, AttributeSet attrs) {
